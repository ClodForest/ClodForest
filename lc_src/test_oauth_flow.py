#!/usr/bin/env python3
"""
Test script for ClodForest OAuth2 DCR implementation
Simulates Claude.ai's OAuth flow
"""
...
async def test_oauth_flow():
    """Test the complete OAuth2 DCR flow"""
    base_url = "http://localhost:8000"
    
    async with httpx.AsyncClient() as client:
        print("🔍 Testing OAuth2 DCR Flow...")
        print("="*50)
